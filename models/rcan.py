...
class RCAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        print("HERE : ", args["in_chan"])
        print("rgb_std: {} | rgb_mean: {}".format(rgb_std, rgb_mean))
        self.sub_mean = common.MeanShift(args["rgb_range"], rgb_mean, rgb_std, in_chan=args["in_chan"])
        ...
        self.add_mean = common.MeanShift(args["rgb_range"], rgb_mean, rgb_std, 1, in_chan=args["in_chan"])
...
def make_cleaning_net(rgb_range=255, rgb_mean=(0.5, 0.5, 0.5), in_chan=3):
...
def make_SR_net(rgb_range=255, rgb_mean=(0.5, 0.5, 0.5), scale_factor=4, in_chan=3):
