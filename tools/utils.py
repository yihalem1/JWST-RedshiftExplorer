...
def tensor_to_image(tensor, img_range, rgb=True, in_chan=3):
...
def save_tensor_image(file_name, tensor, img_range, rgb=True, in_chan=3):
    img = tensor_to_image(tensor, img_range=img_range, rgb=rgb, in_chan=in_chan)
